...
<div class="wrapper">
  ...
  <h2 class="category-header"><image src="<?php echo get_site_url(); ?>/wp-content/themes/BRAVADO/images/MUSIC-header.png"/ alt="Category of MUSIC Header Image"></h2>
...
$wp_query->query('showposts=5&cat=5'.'&paged='.$paged);
?>
